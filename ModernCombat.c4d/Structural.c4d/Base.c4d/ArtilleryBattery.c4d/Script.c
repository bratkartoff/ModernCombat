...
func ControlRightReleased(pByObj)
{
  if(bRotate)
  {
    //Geschützrotationsgeräusche stoppen
...
func ControlLeftReleased(pByObj)
{
  if(bRotate)
  {
    //Geschützrotationsgeräusche stoppen
...
public func OnDestruction()
{
  ...
  //Eventuelles Bewegungsgeräusch stoppen
  Sound("ATBY_CannonRotation.ogg", false, this, 30, 0, -1);
  ...
  {
    CastParticles("ConcreteSplinter",4,110,0,-12,40,100);
    CastParticles("ConcreteSplinter",8,150,0,-12,40,15,RGB(40,20,20));
  }
