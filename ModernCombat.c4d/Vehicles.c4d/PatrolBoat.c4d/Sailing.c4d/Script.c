...
func SetUp()
{
  ...
  turn_end_dir = -1;
  motor = CreateObject(BTEE,0,0,GetOwner());
  motor->SetBoat(this);
  UpdateDmg();
...
private func UpdateDmg()
{
  ...
  //Schaden auf den Motor übertragen
...
public func OnDestruction()
{
  ...
  if(motor)
  {
    motor->FakeExplode(20, GetLastAttacker()+1);
    RemoveObject(motor);
  }
  ...
  {
    CastParticles("MetalSplinter",4,100,0,0,20,170,GetColorDw());
