...
protected func Initialize()
{
  ...
  pMGStation -> Set(this,60,10,150,280);
  pMGStation -> Arm(LCAC,0,240);
...
public func OnDestruction()
{
  ...
  //Wrack erstellen
  var obj = CreateObject(AEWK, 0, 20, GetLastAttacker());
...
protected func OnChangeDir()
{
  ...
  pEntrance->SetOffset(GetDefCoreVal("Offset", "DefCore", GetID(), 0) * (1 - 2 * GetDir()) / 2, 5);
  //Geschützrotation
  var iTurnedAngle = pMGStation->AimAngle();
  pMGStation->SetAimAngle(360-iTurnedAngle);
}