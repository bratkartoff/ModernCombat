...
{
  //Clonk nicht vorhanden oder stürzt: Abbruch
  ...
  //Unter Clonk genug Platz, Fallgeschwindigkeit des Clonk hoch genug, Fallschirm für diesen Sprung nicht bereits verwendet und Clonk im Freien?
