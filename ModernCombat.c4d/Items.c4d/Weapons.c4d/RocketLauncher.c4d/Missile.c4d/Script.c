...
public func Launch(int iAngle, object pFollow, bool fUnguided, int iXDir, int iYDir)
{
  ...
  if(SecureTime())
  {
    ...
    AddEffect("Blink", this, 50, SecureTime(), this);
  }
}
...
{
  CreateParticle("PSpark", 0, 0, 0, 0, 90, GetPlrColorDw(GetOwner()), this);
  return -1;
}
...
private func Traveling()
{
  ...
  //Im Wasser abstürzen, ansonsten Rauchspur
  if(GBackLiquid())
  {
...
private func Smoking()
{
  ...
  for(var i=0; i<dist; i+=ptrdist)
  {
    ...
    CreateParticle("Smoke3",x,y,xdir,ydir,RandomX(50,80)-fade,RGBa(255,255,255,85+fade),0,0);
  }

  CreateParticle("MuzzleFlash2",-maxx,-maxy,+Sin(GetR()+180,500),-Cos(GetR()+180,500),RandomX(100,160),RGBa(255,200),this);
}
